...
FREQ_TEST_PROCESS_PROPERTITY=vendor.oplus.freqtest.process
FREQ_TEST_RESULT_INFO_PROPERTITY=persist.vendor.oplus.freqtest.info
...
function check_oplus_hypuns_state()
{
...
hypusDisable=$(check_oplus_hypuns_state)
